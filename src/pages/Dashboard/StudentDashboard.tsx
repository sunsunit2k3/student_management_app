...
// Dữ liệu mẫu (Mock data) - Trong thực tế nên fetch từ API
const stats = [
...
const StudentDashboard: React.FC = () => {
  ...
  // 2. Xử lý hiển thị tên (fallback nếu thiếu field)
  ...
  return (
    <div className="min-h-screen w-full bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      ...
      <main className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        {/* 1. Welcome Section */}
        <section>
          <h2 className="text-3xl font-bold mb-1">Xin chào, {displayName}! 👋</h2>
          <p className="text-gray-500 dark:text-gray-400">
            Mã sinh viên: <span className="font-medium text-gray-700 dark:text-gray-300">{user?.id || "SV2024..."}</span>
          </p>
          <p className="text-sm text-gray-400 mt-1">Đây là tổng quan tình hình học tập của bạn.</p>
        </section>
