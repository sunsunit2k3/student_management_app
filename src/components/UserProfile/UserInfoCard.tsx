...
export default function UserInfoCard() {
  ...
  useEffect(() => {
    if (isOpen) {
      setFirstName((user as any)?.firstName ?? user?.fistName ?? "");
      setLastName((user as any)?.lastName ?? user?.lastName ?? "");
  ...
  const handleSaveAsync = async () => {
    ...
    try {
      ...
      console.error('UserInfoCard: save error', err);
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
              <div>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                  {(user as any)?.firstName ?? user?.fistName ?? ''}
                </p>
              </div>
        ...
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
          ...
          <form className="flex flex-col">
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  {/* Phone and Bio removed per request */}
                </div>
              </div>
            </div>
            <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
              ...
              <Button size="sm" onClick={handleSaveAsync} disabled={isSaving}>
